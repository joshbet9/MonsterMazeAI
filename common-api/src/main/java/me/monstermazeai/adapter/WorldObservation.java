...
public final class WorldObservation {
    ...
    public WorldObservation(long worldTick, boolean inMonsterMaze, boolean mazeDetected,
    ...
    public WorldObservation copy() {
        return new WorldObservation(worldTick, inMonsterMaze, mazeDetected, alive, completed,
