...
public final class AbilityDecision {
    ...
    public static boolean shouldUse(GameState s){
        if(s==null||!s.alive||s.completed||s.maze==null
                ||s.kit==Kit.JUMPER||s.kit==Kit.MAVERICK)return false;
        ...
        // Preserve charge resources during stage 1 unless there is a concrete
        // survival or deadline reason. Cryo Blitz is cooldown based.
    ...
    private static int travelTicks(GameState s){
        ...
        List<Cell> path=new PlayerPathfinder().shortestPath(s.maze,new Cell(r,c),
